...
def Transaction_amount_count_Y(df,year):
    ...
    with col1:
        ...
        fig_amount=px.bar(tacyg, x="States", y="Transaction_amount",title=
                    f"{year}TRANSACTION_AMOUNT",color_discrete_sequence=px.colors.sequential.Aggrnyl,height=650,width=500)
        st.plotly_chart(fig_amount)
    with col2:
        fig_count=px.bar(tacyg, x="States", y="Transaction_count",title=f"{year} TRANSACTION_COUNT",color_discrete_sequence=px.colors.sequential.Bluered_r,height=650,width=500)
    ...
    with col1:
        fig_india_1= px.choropleth(tacyg, geojson= data1, locations= "States", featureidkey= "properties.ST_NM",
                                ...
                                hover_name= "States",title = f"{year} TRANSACTION AMOUNT", fitbounds= "locations",width =600, height= 600)
    ...
    with col2:
        fig_india_2= px.choropleth(tacyg, geojson= data1, locations= "States", featureidkey= "properties.ST_NM",
                                ...
                                hover_name= "States",title = f"{year} TRANSACTION COUNT", fitbounds= "locations",width =600, height= 600)
...
def Transaction_amount_count_Y_Q(df,quarter):
    ...
    with col1:
        ...
        fig_amount=px.bar(tacyg, x="States", y="Transaction_amount",title=
                        f"{tacy['Years'].min()} YEAR {quarter} TRANSACTION_AMOUNT",color_discrete_sequence=px.colors.sequential.Aggrnyl)
        st.plotly_chart(fig_amount)
 
    with col2:
        fig_count=px.bar(tacyg, x="States", y="Transaction_count",title=f"{tacy['Years'].min()} YEAR{quarter}  TRANSACTION_COUNT",color_discrete_sequence=px.colors.sequential.Aggrnyl)
        st.plotly_chart(fig_count)
    ...
    with col1:
        ...
        fig_india_1= px.choropleth(tacyg, geojson= data1, locations= "States", featureidkey= "properties.ST_NM",
                                color= "Transaction_amount", color_continuous_scale= "Sunsetdark",
                                range_color= (tacyg["Transaction_amount"].min(),tacyg["Transaction_amount"].max()),
                                hover_name= "States",title = f"{tacy['Years'].min()} YEAR {quarter} QUARTER TRANSACTION AMOUNT", fitbounds= "locations",width =600, height= 600)
        fig_india_1.update_geos(visible =False)
        st.plotly_chart(fig_india_1)
    ...
    with col2:
        ...
        fig_india_2= px.choropleth(tacyg, geojson= data1, locations= "States", featureidkey= "properties.ST_NM",
                                color= "Transaction_count", color_continuous_scale= "Sunsetdark",
                                range_color= (tacyg["Transaction_count"].min(),tacyg["Transaction_count"].max()),
                                hover_name= "States",title = f"{tacy['Years'].min()} YEAR {quarter} QUARTER TRANSACTION COUNT", fitbounds= "locations",width =600, height= 600)
...
def Aggre_Tran_Transaction_type(df,state):
    ...
    with col1:
        ...
        fig_pie_1=px.pie(data_frame= tacyg, names= "Transaction_type",values="Transaction_amount",
                            width=600, title=f"{state.upper()} TRANSACTION AMOUNT", hole=0.5,color_discrete_sequence=px.colors.sequential.Aggrnyl)

        st.plotly_chart(fig_pie_1)
    with col2:
        fig_pie_2=px.pie(data_frame= tacyg, names= "Transaction_type",values="Transaction_count",
                        width=600, title=f"{state.upper()} TRANSACTION COUNT", hole=0.5,color_discrete_sequence=px.colors.sequential.Aggrnyl )

        st.plotly_chart(fig_pie_2)

# Aggregated_Analysis_1
def Aggre_user_plot_1(df, year):
    ...
    fig_bar_1=px.bar(aguyg, x= "Brands", y= "Transaction_count", title=f"{year} BRAND AND TRANSACTION COUNT",
                    width =850, color_discrete_sequence=px.colors.sequential.haline,hover_name="Brands")
...
def Aggre_user_plot2(df,quarter):
    ...
    fig_bar_2=px.bar(aguyqg, x= "Brands", y= "Transaction_count", title=f"{quarter} QUARTER BRAND AND TRANSACTION COUNT",
...
def map_user_plot_1(df,year):
    ...
    fig_line_1=px.line(muyg, x="States", y=["RegisteredUser", "AppOpens" ],
                        title=f"{year} REGISTER USER APP OPENS", width=850, height=800, markers=True,color_discrete_sequence= px.colors.sequential.Bluered_r)
    st.plotly_chart(fig_line_1)
...
def map_user_plot_2(df, quarter):
    ...
    fig_map_user_plot_1= px.line(muyqg, x= "States", y= ["RegisteredUser","AppOpens"], markers= True,
                                title= f"{df['Years'].min()}, YEARS {quarter} QUARTER REGISTERED USER AND APPOPENS",
...
def map_user_plot_3(df, state):
    ...
    col1,col2= st.columns(2)
    with col1:
        fig_map_user_plot_1= px.bar(muyqsg, x= "RegisteredUser",y= "District",orientation="h",
...
def top_chart_transaction_amount(table_name):
    ...
    with col1:
        ...
        fig_amount_1=px.bar(df_1, x="states", y="transaction_amount",title="TRANSACTION_AMOUNT",
    ...
    with col2:
        ...
        fig_amount_2=px.bar(df_2, x="states", y="transaction_amount",title="TRANSACTION_AMOUNT",
    ...
    fig_amount_3= px.bar(df_3, y="states", x="transaction_amount", title="AVERAGE OF TRANACTION_AMOUNT", hover_name= "states", orientation= "h",
...
def top_chart_transaction_count(table_name):
    ...
    col1,col2= st.columns(2)
    with col1:
        fig_count=px.bar(df_1, x="states", y="transaction_count",title="TRANSACTION_COUNT",
                        color_discrete_sequence=px.colors.sequential.Aggrnyl,height=650,width=600)
        st.plotly_chart(fig_count)
        #PLOT_2
    ...
    with col2:
        fig_count_2=px.bar(df_2, x="states", y="transaction_count",title="TRANSACTION_COUNT",
                        color_discrete_sequence=px.colors.sequential.Aggrnyl_r,height=650,width=600)
    ...
    fig_count_3= px.bar(df_3, y="states", x="transaction_count", title="AVERAGE OF TRANSACTION_COUNT", hover_name= "states", orientation= "h",
                            color_discrete_sequence=px.colors.sequential.Bluered_r, height= 800,width= 1000)
...
def top_chart_registered_user(table_name, state):
    ...
    col1,col2=st.columns(2)
    with col1:
        fig_count_1=px.bar(df_1, x="districts", y="registereduser",title="TOP 10 REGISTERED USER",
                        color_discrete_sequence=px.colors.sequential.Aggrnyl,height=650,width=600)
    ...
    with col2:
        fig_count_2=px.bar(df_1, x="districts", y="registereduser",title="LAST 10 REGISTERED USER",
                        color_discrete_sequence=px.colors.sequential.Aggrnyl_r,height=650,width=600)
        st.plotly_chart(fig_count_2)
    ...
    fig_count_3= px.bar(df_3, y="districts", x="registereduser", title="AVERAGE OF INSURANCE_COUNT", orientation= "h",
                                color_discrete_sequence=px.colors.sequential.Bluered_r, height= 800,width= 1000)
...
def top_chart_appopens(table_name, state):
    ...
    col1,col2=st.columns(2)
    with col1:
        fig_count_1=px.bar(df_1, x="districts", y="appopens",title="TOP 10 APP OPENS",
                        color_discrete_sequence=px.colors.sequential.Aggrnyl,height=650,width=600)
        st.plotly_chart(fig_count_1)
    ...
    with col2:
        fig_count_2=px.bar(df_1, x="districts", y="appopens",title="LAST 10 APP OPENS",
                        color_discrete_sequence=px.colors.sequential.Aggrnyl_r,height=650,width=600)
        st.plotly_chart(fig_count_2)
    ...
    fig_count_3= px.bar(df_3, y="districts", x="appopens", title="AVERAGE OF APP OPENS", orientation= "h",
                                color_discrete_sequence=px.colors.sequential.Bluered_r, height= 800,width= 1000)
...
def top_chart_registered_users(table_name):
    ...
    with col1:
        ...
        fig_amount= px.bar(df_1, x="states", y="registereduser", title="TOP 10 OF REGISTERED USERS",
                            color_discrete_sequence=px.colors.sequential.Aggrnyl, height= 650,width= 600)
        st.plotly_chart(fig_amount)
    ...
    with col2:
        ...
        fig_amount_2= px.bar(df_2, x="states", y="registereduser", title="LAST 10 REGISTERED USERS",
                            color_discrete_sequence=px.colors.sequential.Aggrnyl_r, height= 650,width= 600)
        st.plotly_chart(fig_amount_2)
...
if select == "Home":
    ...
    with col2:
        st.image(Image.open(r"C:\Users\user\Downloads\phone-pay-image-1024x512.jpg"),width= 600)

    col3,col4= st.columns(2)

    with col3:
        st.image(Image.open(r"C:\Users\user\Downloads\phonepe-image-1200x600.jpg"),width=600)
    ...
    with col6:
        st.image(Image.open(r"C:\Users\user\Downloads\PhonePeTx-02-1024x536.webp"),width= 600)

elif select == "Data Exploration":
    
    tab1, tab2, tab3 =st.tabs(["Aggregated Anaysis","Map Analysis","Top Analysis"])
    ...
    with tab1:
        ...
        if method == "Insurance Analysis":
            ...
            with col1:
                ...
                Quarters= st.slider("**Select the Quarter**", Aggre_insurance["Years"].min(), tac_y["Quarter"].max(),tac_y["Quarter"].min())
            ...
            with col1:
                ...
                Quarters= st.slider("**Select the Quarter**", Aggre_insurance["Years"].min(),   Aggre_tran_tac_y["Quarter"].max(),  Aggre_tran_tac_y["Quarter"].min())

            Aggre_tran_tac_y_Q=Transaction_amount_count_Y_Q(Aggre_tran_tac_y,Quarters)

            col1,col2 =st.columns(2)
            with col1:
                states=st.selectbox ("Select the States",  Aggre_tran_tac_y_Q["States"].unique())
    ...
    with tab3:
        ...
        if method_3 == "Top Insurance":
            col1,col2= st.columns(2)
            with col1:
                years= st.slider("Select The Year_TU",top_insurance["Years"].min(), top_insurance["Years"].max(),top_insurance["Years"].min())
